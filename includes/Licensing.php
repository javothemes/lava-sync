...
class Licensing
{
    ...
    public $license_server_service = "https://moon114.com/wp-json/lava-sync/com/v1/license/";
    public $synchronization_server_service = "https://moon114.com/wp-json/lava-sync/com/v1/synchronizerequest/";
        ...
        if ($verified_license) {
            ...
            if ($sync_request_result->isSuccess()) {
                ...
                if (isset($body->valid) && $body->valid === true) {
                    ...
                    $result->state = false;
                    $result->errors[] = __("Synchronization was denied by license server - Check log for details", "wpsynchro");
                }
            } else {
                $result->state = false;
