        ...
        <div id="wpsynchro-overview" class="wrap wpsynchro">
            ...
            if ($success_count >= 10 && !$request_review_dismissed) {
                ...
                <div class="notice notice-success wpsynchro-dismiss-review-request" >
                    ...
                    <p><a class="wpsynchrobutton" href="https://wordpress.org/support/plugin/lava-sync/reviews/?rate=5#new-post" target="_blank"><?php _e('Rate WP Synchro on WordPress.org', 'moon114textdomain'); ?></a> <button class="wpsynchrobutton-secondary" data-dismiss-url="<?php echo esc_url($dismiss_url); ?>"><?php _e('Dismiss forever', 'moon114textdomain'); ?></button></p>
                </div>
                <?php
            } */ ?>
            ...
            <div id="overview-section-container">
                <div class="installations">
                    ...
                    <div class="typefilters addinstallation">
                        <?php $table->views(); ?>
                        <a class="addlink" href="<?php menu_page_url('wpsynchro_addedit', true); ?>"><button class="wpsynchrobutton"><?php _e('Add installation', 'moon114textdomain'); ?></button></a>
                    </div>
